...
/**
 * The two return-number context maps shared by the point14 encoder and decoder,
 * indexed as {@code [numReturns][returnNum]} (both 0..15). Lifted verbatim from
 * laz-perf's {@code field_point14.cpp}.
 */
final class Point14Tables {
    private Point14Tables() {}

    /** 6-context map used to pick the X/Y median predictor context. */
    static final int[][] RETURN_MAP_6 = {
    ...
    /** 8-context map used to pick the Z predictor context. */
    static final int[][] RETURN_LEVEL_8 = {
